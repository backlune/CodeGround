...
namespace IO.Swagger.Model
{
        ...
        public partial class Product :  IEquatable<Product>, IValidatableObject
    {
        ...
        public Product(Guid? productId = default(Guid?), string name = default(string), double? price = default(double?), string description = default(string), string imageUrl = default(string))
        {
